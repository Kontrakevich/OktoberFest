...
addEventListener("touchstart",e=>{if(!e.target.closest("#hint"))cancelAutoScroll()},{passive:true});addEventListener("resize",fitSalute);addEventListener("orientationchange",()=>setTimeout(fitSalute,250));fitSalute();document.querySelectorAll(".salute-line").forEach(capFirst);capFirst(document.querySelector(".section-title"));capFirst(document.querySelector(".address a"));requestAnimationFrame(render)})();