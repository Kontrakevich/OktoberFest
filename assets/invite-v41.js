...
function render(){
  ...
  if(hero1){
    hero1.style.opacity=String(1-heroDim);
    hero1.style.filter='brightness('+(1-heroDim*.72)+')';
    hero1.style.transform='none';
  }

  if(hint){
    hint.style.transform='translate3d(-50%,0,0)';
    hint.style.opacity=String(1-heroDim);
    hint.style.filter='brightness('+(1-heroDim*.72)+')';
  }
