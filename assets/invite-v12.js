...
addEventListener("touchstart",unlock,{once:true,passive:true});addEventListener("pointerdown",unlock,{once:true,passive:true});addEventListener("wheel",unlock,{once:true,passive:true});addEventListener("resize",fitSalute);addEventListener("orientationchange",()=>setTimeout(fitSalute,250));fitSalute();requestAnimationFrame(render)})();